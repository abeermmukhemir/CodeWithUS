<?php
    ...
    $sql=DBConnect()->prepare("SELECT * FROM explaining WHERE explaining.lang_name=?");
...
<head>
    <meta charset="UTF-8">
    <title>Explanatory text</title>
    <link rel="StyleSheet" href="css/bootstrap.css" type="text/css">
    <link rel="StyleSheet" href="ExplanatoryTextStyle.css" type="text/css">
...
<div id="mySidenav" class="sidenav">
    ...
    foreach ($result as $raw){
        echo '<a class="myanchor" href="ExplanatoryText.php?id=' . $raw[0] . '"  id="' . $raw[0] . '">' . $raw[0] . '</a>';
    }
